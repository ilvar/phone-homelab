    ...
    Scaffold(
        ...
        Column(Modifier.fillMaxSize().padding(padding).imePadding()) {
            ...
            if (!state.ready) CircularProgressIndicator(Modifier.padding(24.dp))
                ...
                Screen.SETTINGS -> SettingsScreen(state, model::connect, model::chooseEndpoint, model::addSource, model::removeSource, model::runVm, model::vmPermissionResult, model::stopVm, model::vmConsole, model::vmLog)
